...
<style>
  /* =========================================================
     ...
     Todo vive dentro de #expensesPage
     ========================================================= */
  #expensesPage{
  ...
  /* Fondo SOLO para esta vista (no body) */
  ...
  #expensesPage .page-wrap{ max-width:1200px; }
  ...
  #expensesPage .hero h1{ font-weight:900; letter-spacing:-.02em; }
  #expensesPage .subtle{ color:var(--muted) }
  ...
  #expensesPage .btn-pastel-blue:hover{ transform:translateY(-1px); filter:brightness(1.02); box-shadow:0 12px 26px rgba(96,165,250,.30) }
  ...
  #expensesPage .btn-pastel-green:hover{ transform:translateY(-1px); filter:brightness(1.02); box-shadow:0 12px 26px rgba(52,211,153,.26) }
  ...
  #expensesPage .btn-outline-soft:hover{ background:#f8fafc; box-shadow:0 10px 24px rgba(2,6,23,.06); transform:translateY(-1px) }

  #expensesPage .card{ border:1px solid var(--border); border-radius:16px; box-shadow:var(--shadow); background:var(--panel) }
  #expensesPage .card .card-header{ background:#fff; border-bottom:1px solid var(--border); color:var(--muted); font-weight:800; }

  #expensesPage .form-label{ color:var(--muted); font-weight:700; font-size:.86rem; }
  ...
  #expensesPage .metrics-grid{ display:grid; gap:12px; grid-template-columns: repeat(4, 1fr); }
  ...
  #expensesPage .metric-card{ padding:14px }
  #expensesPage .metric-title{ color:var(--muted); font-size:.78rem; text-transform:uppercase; letter-spacing:.04em; font-weight:900; display:flex; align-items:center; justify-content:space-between; gap:10px; }
  #expensesPage .metric-value{ font-weight:1000; font-size:1.75rem; line-height:1.1; margin-top:6px; }
  #expensesPage .metric-sub{ color:#64748b; font-weight:800; font-size:.92rem; margin-top:6px; }
  #expensesPage .metric-pill{ display:inline-flex; align-items:center; gap:.4rem; padding:.25rem .55rem; border-radius:999px; font-size:.75rem; font-weight:900; border:1px solid transparent; }
  #expensesPage .pill-out{ background:var(--pred); color:#7f1d1d; border-color:rgba(239,68,68,.45) }
  #expensesPage .pill-ret{ background:var(--pteal); color:#0c4a6e; border-color:rgba(14,165,233,.45) }
  #expensesPage .pill-can{ background:#eef2f8; color:#334155; border-color:rgba(148,163,184,.55) }
  #expensesPage .pill-count{ background:#f8fafc; color:#334155; border:1px solid rgba(148,163,184,.35); padding:.32rem .7rem; font-weight:1000; }

  #expensesPage .expected-ok{ background:#f1fff7; }
  #expensesPage .skeleton{ position:relative; overflow:hidden; background:#eef2f8; border-radius:10px; min-height:22px }
  #expensesPage .skeleton::after{
    content:""; position:absolute; inset:0; transform:translateX(-100%);
    background: linear-gradient(90deg, transparent, rgba(255,255,255,.6), transparent);
    animation: expensesShimmer 1.1s infinite;
  }
  @keyframes expensesShimmer{ 100% { transform: translateX(100%); } }

  #expensesPage .grid{ display:grid; grid-template-columns:repeat(2, minmax(0,1fr)); gap:14px; }
  ...
  #expensesPage .thumb .small{ color:#64748b }
  #expensesPage .title{
    font-weight:1000; letter-spacing:-.01em; font-size:15px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;
  }
  #expensesPage .amount{ font-weight:1000; }
  #expensesPage .meta2{ display:flex; flex-wrap:wrap; gap:8px; color:#667085; font-size:12px; }
  #expensesPage .tag{
    display:inline-flex; align-items:center; gap:6px;
    padding:6px 10px; border-radius:999px; border:1px solid #e7eaf0; background:#fff;
    font-weight:800;
  }
  #expensesPage .tag.soft{ background:#f8fafc; }
  #expensesPage .empty{
  ...
  #expensesPage #chart{ width:100%; height:330px; }
  #expensesPage #pieChart{ width:100%; height:320px; }

  #expensesPage .mini-error{ background:#fff3cd; border:1px solid #ffe69c; color:#664d03; padding:.6rem .8rem; border-radius:10px; font-size:.9rem; }

  #expensesPage .tabs-row{
    display:flex; align-items:center; justify-content:space-between;
    gap:12px; margin-top:12px;
  }
  #expensesPage .tabs-pills{ display:flex; gap:8px; flex-wrap:wrap; }
  ...
  #expensesPage .tab-pill:hover{ transform:translateY(-1px); box-shadow:0 12px 26px rgba(2,6,23,.06); background:#f8fafc }
  ...
  #expensesPage .mobile-switch{ display:none; margin-top:12px; }
  @media (max-width: 767.98px){
    #expensesPage .tabs-row{ display:none; }
    #expensesPage .mobile-switch{ display:block; }
    #expensesPage .mobile-switch .form-select{ border-radius:14px; font-weight:900; }
  }

  /* ✅ Encapsula modal SOLO si el modal trae .expenses-scope */
  .modal.expenses-scope .modal-content{
    border:1px solid var(--border);
    border-radius:18px;
...
(() => {
  ...
  function setPercentLine(elId, part, total){
    const el = $(elId);
    if(!el) return;
    el.textContent = `${pct(part, total)}% del total`;
  }
