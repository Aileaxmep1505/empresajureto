...
<style>
  ...
  /* ════════════ SIDEBAR LATERAL COMPARTIDO — NO INVADE HEADER GLOBAL ════════════ */
  :root { --cc-global-header-height: 64px; }
  ...
  .cc-side-nav {
    ...
    background: #ffffff;
    border-right: 1px solid var(--line, #ebebeb);
    display: flex;
    flex-direction: column;
    align-items: center;
    padding: 14px 10px;
  ...
  .cc-side-nav__top { margin-bottom: 18px; }
  .cc-side-nav__main { margin-top: 6px; }
  ...
  @media (max-width: 900px) {
    ...
    .pjd-wrap.has-control-sidebar { padding-left: 0 !important; }
  }
          ...
          <div class="pjd-card-head pjd-ficha-head">
            ...
            <div class="pjd-ficha-actions" onclick="event.stopPropagation();">
              ...
              @if($project->status === 'processing')
                <span class="pjd-ficha-action" style="cursor:default;opacity:.78;">
                  Procesando...
                </span>
              @endif
