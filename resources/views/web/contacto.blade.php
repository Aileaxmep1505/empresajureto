...
<style>
  ...
  @media (max-width: 992px){ .right{border-radius:0} }
  ...
  <div class="contact-card">
    ...
    <div class="left">
      ...
      <form method="POST" action="{{ route('web.contacto.send') }}" novalidate>
        ...
        <div class="field">
          <input name="nombre" value="{{ old('nombre') }}" placeholder="Nombre completo"
                 class="input @error('nombre') invalid @enderror" required minlength="2" maxlength="100">
        ...
        <div class="field">
          <input name="telefono" value="{{ old('telefono') }}" placeholder="Teléfono (10 dígitos)"
                 class="input @error('telefono') invalid @enderror"
        ...
        <button class="btn-grad" type="submit"><span>Enviar</span></button>
      </form>
    </div>

    {{-- Derecha: Información de contacto (sin cambios de diseño) --}}
    <aside class="right">
      <h2 class="r-title">Información de contacto</h2>

      <div class="info-row">
        <i class="fa-solid fa-headset" aria-hidden="true"></i>
        <div><a href="tel:+525541937243">+52 55 4193 7243</a></div>
      </div>

      <div class="info-row">
        <i class="fa-solid fa-envelope-open-text" aria-hidden="true"></i>
        <div><a href="mailto:rtort@jureto.com.mx">rtort@jureto.com.mx</a></div>
      </div>
