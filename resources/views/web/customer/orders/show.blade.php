      ...
      <div class="card" style="margin-bottom:18px;">
        ...
        <div class="card-b">
          <div style="margin-bottom:16px;">
            @if(in_array($rawStatus, ['pagado', 'paid', 'completado', 'completed', 'entregado']))
              <span class="badge ok">{{ $statusLabel }}</span>
            @elseif(in_array($rawStatus, ['cancelado', 'cancelled', 'canceled']))
              <span class="badge bad">{{ $statusLabel }}</span>
            @else
              <span class="badge info">{{ $statusLabel }}</span>
            @endif
          </div>
