...
<head>
  ...
  <title>Crear cuenta - Soluciones Jureto</title>
...
<body>
  <div class="page">
    <main class="auth-panel">
      <div class="auth-wrap">
        ...
        <form method="POST" action="{{ route('register.post') }}" class="form" id="registerForm" novalidate>
          @csrf

          {{-- Modo de registro: cliente por defecto, interno si llega ?internal=1 (sin UI visible) --}}
          ...
          <div class="field">
            ...
            <div class="inputBx has-toggle @error('password') invalid @enderror">
              ...
              >
                <svg class="icon-eye" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                  <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7Z"/>
                  <circle cx="12" cy="12" r="3"/>
                </svg>
                <svg class="icon-eye-off" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <div class="links-row">
            ...
            <a class="auth-link" href="{{ route('login') }}">Inicia sesión</a>
          </div>

          <button type="submit" class="btn-submit" id="btnRegister" data-loading="false">
  ...
  <script>
    (function(){
      // ===== Toggle de visibilidad (funciona para ambos campos) =====
      ...
      if (form && btnRegister) {
        form.addEventListener('submit', function(){
          btnRegister.dataset.loading = 'true';
        });
      }
    })();
  </script>
