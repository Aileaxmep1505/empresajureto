{{-- resources/views/confidential/pin.blade.php --}}
@extends('layouts.app')
    ...
    <div class="pin-container">
        <div class="pin-card {{ $shouldShake === 'true' ? 'animate-shake' : '' }}">
            ...
            <div class="pin-header">
                <a href="{{ route('confidential.vault', $owner->id) }}" class="btn-back">
            ...
            <div class="pin-branding">
                ...
                <p class="brand-subtitle">
                    Ingresa el NIP para acceder al vault de <br>
                    <strong>{{ $owner->name ?? ('Usuario #'.$owner->id) }}</strong>
                    <span style="display:block; margin-top:6px;">
                        El acceso dura <strong>30 min</strong>.
                    </span>
                </p>
            </div>

            {{-- FORMULARIO --}}
            <form id="pinForm" method="POST" action="{{ route('confidential.vault.unlock', $owner->id) }}" autocomplete="off">
                @csrf
                ...
                <div class="pin-footer">
                    <a href="{{ url('/panel/perfil') }}" class="pin-link">Configurar NIP</a>
                </div>
            </form>
...
:root{
    /* Estilo “screenshot” */
    --bg-top: #dbeafe;       /* azul muy suave */
    --bg-mid: #eef2ff;       /* indigo suave */
    --bg-base: #ffffff;
