    ...
    <div class="panel">
        ...
        <form class="form" action="{{ route('licitaciones.update.step7', $licitacion) }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="block">
                <div class="uploader">
                    <div class="uploader-top">
                        <label for="archivo_fallo" class="btn-file">
                            Seleccionar archivo de fallo (PDF)
                        </label>
                        <input
                            id="archivo_fallo"
                            type="file"
                            ...
                            style="display:none;"
                        >
                        <span id="file-name-fallo" class="file-chosen">
                            Ningún archivo seleccionado
                        </span>
                    </div>
                    <p class="small">
                ...
                <div>
                    <div class="field">
                        <select name="resultado" id="resultado">
                            <option value="ganado" {{ old('resultado', $licitacion->resultado) === 'ganado' ? 'selected' : '' }}>Ganado</option>
                            <option value="no_ganado" {{ old('resultado', $licitacion->resultado) === 'no_ganado' ? 'selected' : '' }}>No ganado</option>
                        </select>
                ...
                <div>
                    <div class="field">
                        <input
                            ...
                            name="fecha_fallo"
                            id="fecha_fallo"
                            value="{{ old('fecha_fallo', optional($licitacion->fecha_fallo)->format('Y-m-d')) }}"
                            placeholder=" "
                        >
            ...
            <div class="actions-line">
                <a href="{{ route('licitaciones.edit.step6', $licitacion) }}" class="link-back">
