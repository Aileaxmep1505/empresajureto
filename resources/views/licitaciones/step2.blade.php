    ...
    <div class="panel">
        <div class="panel-head">
            <div class="hgroup">
                ...
                <h2>Subir documento de convocatoria</h2>
                <p>Adjunta el archivo oficial de la convocatoria (PDF, Word o Excel).</p>
            </div>
        ...
        <form class="form" action="{{ route('licitaciones.update.step2', $licitacion) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="block">
                <div class="uploader">
                    ...
                    <p class="small">
                        ...
                        Procura que sea la versión oficial publicada en la convocatoria.
                    </p>
                </div>
            </div>
...
<script>
(function(){
    const input = document.getElementById('archivo_convocatoria');
