...
<div class="page-licitaciones-show">
    ...
    <div class="top-actions">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:6px;">
            ...
            {{-- Botón para descargar Excel de los ítems de ESTA licitación --}}
            <a href="{{ route('licitaciones-ai.excel', $licitacionFile) }}" class="btn-primary-soft">
                {{-- Icono mini de descarga (SVG inline) --}}
    ...
    <div class="table-card">
        <div class="table-card-header">
            <div>
                ...
                <span style="font-size:0.75rem;color:#6b7280;">
                    Vista previa de los renglones detectados. Puedes editar cualquier ítem desde el botón "Editar".
                </span>
            </div>
        ...
        <table>
            ...
            @else
                ...
                {{-- Fila de "sin resultados" para cuando el filtro no encuentre nada --}}
...
<div class="ia-modal" id="ia-edit-modal">
    ...
    <div class="ia-modal-panel">
        <div class="ia-modal-header">
            <div>
                <div class="ia-modal-title">Editar ítem de licitación</div>
                <div class="ia-modal-sub">
                    Ajusta los campos necesarios. Al guardar, el ítem se reubicará según la partida.
                </div>
            </div>
        ...
        <form method="POST" id="ia-edit-form" action="">
            ...
            <div class="ia-modal-grid">
                ...
                <div class="ia-modal-field">
                    ...
                    <input type="text" id="ia-edit-unidad" name="unidad_medida" class="ia-input">
                </div>
                <div class="ia-modal-field">
                    <label for="ia-edit-cantidad">Cantidad</label>
                    <input type="number" step="1" min="0" id="ia-edit-cantidad" name="cantidad" class="ia-input">
                </div>
            </div>
            ...
            <div style="margin-top:10px;">
                <div class="ia-modal-field" style="margin-bottom:8px;">
                    ...
                    <textarea id="ia-edit-descripcion" name="descripcion_bien" class="ia-textarea"></textarea>
                </div>
                <div class="ia-modal-field">
...
{{-- Filtro de búsqueda + lógica modal --}}
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ===== Modal edición =====
        const modal = document.getElementById('ia-edit-modal');
        const form  = document.getElementById('ia-edit-form');
        ...
        function openModalWithItem(btn) {
            ...
            fieldCant.value  = btn.getAttribute('data-cantidad')           || '';
        ...
        document.querySelectorAll('.btn-row-edit').forEach(btn => {
            btn.addEventListener('click', () => openModalWithItem(btn));
        });
